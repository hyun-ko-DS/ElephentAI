...
FEATURES_NPY: str = "embeddings/train_features_vit_g_14_mean.npy"  # train 폴더 이미지들의 임베딩 벡터
PATHS_NPY: str = "embeddings/train_paths_vit_g_14_mean.npy"        # train 폴더 이미지들의 파일 경로
...
def run_automated_similarity_search() -> None:
    ...
    csv_filename = f"{MODEL_NAME.replace('/', '_').replace('-', '_')}_mean_result.csv"
