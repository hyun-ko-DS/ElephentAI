...
OUT_FEATURES: str = "embeddings/train_features_vit_g_14_mean_mixed.npy"  # 폴더별 평균 임베딩 벡터 저장 파일
OUT_PATHS: str = "embeddings/train_paths_vit_g_14_mean_mixed.npy"        # 폴더 경로 저장 파일
