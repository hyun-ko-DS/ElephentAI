...
OUT_FEATURES: str = "embeddings/train_features_vit_H_14.npy"  # 임베딩 벡터 저장 파일
OUT_PATHS: str = "embeddings/train_paths_vit_H_14.npy"        # 이미지 경로 저장 파일

# OpenCLIP 모델 설정
MODEL_NAME: str = 'ViT-H-14'      # 거대 모델 (1024차원, 매우 정확함)     
 # 사전 훈련된 가중치
